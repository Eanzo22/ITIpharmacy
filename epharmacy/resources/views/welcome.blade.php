                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown show">
                        ...
                        <ul class="sub-menu children active dropdown-menu show">
                            <li class="subtitle"> <i class="fa fa-plus-square"></i> Catogeries</li>
                            @foreach( $categories as $category)
                            <li><i class="fa fa-medkit"></i><a href="">{{ $category -> name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
                </ul>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a href="./"><img src="{{URL::asset('images/logo.png')}}" alt="logo" width="100" height="40"></a>
                    ...
                    <div class="header-left">
                        ...
                        <div class="form-inline">
                            <form class="search-form" action="" method="GET">
                                <input class="form-control mr-sm-2" name="search" value="" type="text" placeholder="Search products" aria-label="Search">
                                <button class="btn bg-primary" type="submit"><i class="fa fa-search"></i></button>
                            </form>
                        </div>
                        @guest
                        <a href="{{route('login')}}" style="color:blue"><b>Login</b> |</a>
                        <a href="{{route('register')}}" style="color:rgb(17, 165, 223)"><b>Register </b></a>
                        @endguest
                        @auth

                        <a href="{{route('drugs.index')}}" style="color:orange "><b> | ADMIN</b></a>
                        <a href="{{route('logout')}}" style="color:rgb(255,0,0)"><b>logout</b></a>
                        @endauth
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-3 col-xl-3 mb-4 mb-lg-0">
                                    <div class="bg-image hover-zoom ripple rounded ripple-surface">
                                        <img src="{{asset('images/drugs')}}/{{$drug->image}}" class="w-100" />
                                        <a href="#!">
                                ...
                                <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                    <div class="d-flex flex-row align-items-center mb-1">
                                        <h4 class="mb-1 me-1">$ {{$drug->price}}</h4>
                                        <span class="text-danger"><s>${{$drug->price + 7.6}}</s></span>
                                    </div>
                                    <form action="{{route('user.create.order' , $drug->id)}}" method="get">
